  ...
  const SwitchThumbComponent = Thumb.styleable(function(props, forwardedRef) {
    ...
    React.forwardRef(function(propsIn, forwardedRef) {
      const styledContext = React.useContext(import_SwitchContext.SwitchContext), props = (0, import_core.useProps)(propsIn, {
        ...
        // @ts-expect-error
        setButton
      ), labelId = (0, import_label.useLabelContext)(button), labelledBy = ariaLabelledby || labelId, hasConsumerStoppedPropagationRef = React.useRef(!1), isFormControl = import_core.isWeb ? button ? !!button.closest("form") : !0 : !1, [frameWidth, setFrameWidth] = React.useState(0), [checked = !1, setChecked] = (0, import_use_controllable_state.useControllableState)({
        prop: checkedProp,
